...
const char* productionTypeList[NB_PRODUCTION_TYPE] = { "\"FOSSIL_OIL\"", "\"FOSSIL_GAS\"", "\"HYDRO\"", "\"BIOENERGY\"", "\"NUCLEAR\"", "\"FOSSIL_HARD_COAL\"", "\"WIND\"", "\"PUMPING\"", "\"SOLAR\"" };
const int productionCO2[NB_PRODUCTION_TYPE] = { 730, 418, 6, 494, 6, 1060, 14,  10, 43 };                        // geCO2/kWh
const unsigned long meanProduction[NB_PRODUCTION_TYPE] = { 688, 2356, 5046, 446, 34274, 1374, 1020,  0, 185 };  // MW
